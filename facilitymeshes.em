/*
 * This file contains template objects such as a house, a school, a firestation, etc.
 * that are configured to have reasonable relative orientation, scale, and position.
 * Will serve as templates for an updated VillageBuilder where users can cofigure their
 * own objects through the 2d interface.
 */
...
// the following meshes are commented out because they tend to make the world crash
/* 
    schoolmeshes.push({mesh:"meerkat:///kittyvision/picnic_table.dae/optimized/picnic_table.dae",
