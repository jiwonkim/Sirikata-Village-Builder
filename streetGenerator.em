/*
 * Creates meshes of the street system in the world given the parameter
 * vertex grid that specifies how the streets are connected
 */

system.require("std/shim/quaternion.em");
system.import("test/streetTools.em");
...
/*
 * Takes an edge and creates a street mesh in the world
 */
...
/*
 * Takes a node and creates an intersection mesh in the world
 */
 ...
 * @param street is the path graph object
 * @param space is the size of each block
 */
