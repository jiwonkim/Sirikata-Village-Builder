/*
 * Enables client to "order" specific facilities such as house, firestation, school, etc.
 * with certain parameters that encode direction and position of the facility, following
 * which the facility factory creates the specified facility in the world.
 */
